...
class sfAmazonCloudfront {
  ...
  public function __construct($params) {
    $this->_cloudfront = new AmazonCloudFront(array(
    ...
    $this->_id = $params['distribution_id'];
  ...
  public function createInvalidation($paths, $opt = null)
  {
    $caller_reference = sfConfig::get('aws_caller_reference');
    ...
    return $this->_cloudfront->create_invalidation($this->_id, $caller_reference, $paths, $opt = null);
  }
}